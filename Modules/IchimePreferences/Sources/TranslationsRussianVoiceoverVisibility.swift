...
public enum TranslationsRussianVoiceoverVisibility: String, CaseIterable, Identifiable, Sendable {
  case show
  case hide

  public struct UserDefaultsKey {
    public static let VISIBILITY = "translations_russian_voiceover_visibility"
  }
