...
public enum TranslationsRussianSubtitlesVisibility: String, CaseIterable, Identifiable, Sendable {
  case show
  case hide

  public struct UserDefaultsKey {
    public static let VISIBILITY = "translations_russian_subtitles_visibility"
  }
