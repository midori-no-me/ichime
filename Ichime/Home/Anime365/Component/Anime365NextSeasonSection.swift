...
@Observable
private class Anime365NextSeasonSectionViewModel {
...
struct Anime365NextSeasonSection: View {
  let preloadedShows: [ShowPreviewShikimori]

  @State private var viewModel: Anime365NextSeasonSectionViewModel = .init()
