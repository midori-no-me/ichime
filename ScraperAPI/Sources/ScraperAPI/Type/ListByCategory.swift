...
extension ScraperAPI.Types.Show {
  public static let sampleData = ScraperAPI.Types.Show(
    id: 21587,
...
extension ScraperAPI.Types.ListByCategory {
  public static let sampleData = [
    ScraperAPI.Types.ListByCategory(
      ...
      shows: [
        ...
        ScraperAPI.Types.Show(
          ...
          name: ScraperAPI.Types
            .Name(
              ru: "Злодейка девяносто девятого уровня: «Я босс, но не король демонов»",
        ...
        ScraperAPI.Types.Show(
          ...
          name: ScraperAPI.Types
            .Name(
              ru: "Лунное путешествие приведёт к новому миру 2 сезон",
        ...
        ScraperAPI.Types.Show(
          ...
          name: ScraperAPI.Types.Name(
            ru: "Нежеланно бессмертный авантюрист",
            romaji: "Nozomanu Fushi no Boukensha"
          ),
          episodes: (watched: 3, total: 12),
          score: nil
        ),
        ...
        ScraperAPI.Types.Show(
          ...
          name: ScraperAPI.Types
            .Name(
              ru: "Несносные пришельцы 2 сезон (2022)",
        ...
        ScraperAPI.Types.Show(
          ...
          name: ScraperAPI.Types
            .Name(
              ru: "Рубеж Шангри-Ла: Любитель игрошлака бросает вызов топ-игре",
